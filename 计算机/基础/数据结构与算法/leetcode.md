...
2. 依分类
   ...
   - 树：94, 101, 104, 108, 109, 110, 111, 112, 113, 144, 145, 208, 226, 230, 235, 236, 337, 404, 437, 501, 513, 530, 538, 543, 572, 617, 637, 653, 662, 669, 671, 677, 687
...
- 二分搜索关键在于通过mid值与low值或high值的比较，确定要搜索的目标值在list的哪边，如果没法确定在哪边则无法搜索。
...
- 若选择搜索区时不排除mid值，则循环结束时low一定等于high：
